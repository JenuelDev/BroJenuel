...
<template>
    <div id="about-me">
        <div class="">
            ...
            <div class="pt-5 w-full max-w-550px mx-auto px-20px pt-80px">
                <div class="pb-10px indent-md">
                    My name is Jenuel Ganawed or call me BroJenuel. I’m a developer with a full-stack background and a keen eye for good design. Currently, I focus on building apps
                    and software using web tools.
                </div>
                <div class="indent-md">
