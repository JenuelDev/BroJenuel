        ...
        <Transition>
            <div v-show="isShowContent">
                <div class="w-full max-w-500px mx-auto mt-50px px-20px">
                    <div class="font-800 text-size-20px text-[var(--primary)]">My Work</div>
                    <div class="pt-5">
                ...
                <div class="max-w-600px mx-auto px-10px">
                    <div class="grid sm:grid-cols-2 grid-cols-1 gap-3">
                        ...
                        >
                            <div class="p-10px">
                                <img :src="`/img/work/${work.img}`" loading="lazy" class="rounded-md" :alt="work.description" srcset="" width="500" height="500" />
                            </div>
                            <div class="text-center">
                                <div class="font-700 group-hover:text-[var(--primary)]">{{ work.work }} <Icon name="" /></div>
